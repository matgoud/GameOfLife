...
/**
 * Cette Classe permet de faire des tests sur les différentes méthodes de la classe HashLifeqTree.
 * @author : Loic Laloux L2 Informatique TP 3A
 */
public class TestHashLifeqTree {
    ...
    public static boolean TestCreate(){
        HashLifeqTree test1 = new HashLifeqTree(true);
        HashLifeqTree Test1 = new HashLifeqTree(test1,null,null,null);
        HashLifeqTree test2 = new HashLifeqTree(false);
        HashLifeqTree test3 = new HashLifeqTree(true);
        HashLifeqTree test4 = new HashLifeqTree(false);
        HashLifeqTree testtree = new HashLifeqTree(test1,test2,test3,test4);
